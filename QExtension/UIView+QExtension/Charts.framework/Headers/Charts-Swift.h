...
/// \param fromX starting point on the x -axis where the grouping should begin
///
...
/// \param groupSpace groupSpace
///
/// \param barSpace barSpace
///
...
///
/// \param yValue If there are multiple y-values for the specified x-value,
///
...
/// \param duration the duration of the animation in seconds
///
/// \param easingOption easingOption
///
...
/// \param yPx the y-pixel of the highlighted value
///
/// \param dataSetIndex the index of the Data the highlighted value belongs to
///
///
///
/// \param axis references which value of a stacked-bar entry has been selected
///
///
///
...
/// \param atPoint This is the point at which the marker wants to be drawn. You can adjust the offset conditionally based on this argument.
///
///
/// returns:
